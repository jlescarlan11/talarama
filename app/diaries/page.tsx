...
const DiaryPage = async () => {
  ...
  return (
    <>
      <div className="rounded-2xl shadow-lg p-8 mb-8 flex flex-col md:flex-row items-center gap-8 bg-base-200">
        <div className="flex flex-col items-center md:items-start gap-4 md:flex-row md:gap-8 w-full">
          ...
          <div className="flex flex-col items-center md:items-start gap-2">
            ...
            <p className="text-base text-base-content/70">i watch movies for fun.</p>
          </div>
        </div>
